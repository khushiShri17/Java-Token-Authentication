...
import com.auth.tokensystem.security.CustomAccessDeniedHandler;
import com.auth.tokensystem.security.CustomAuthenticationEntryPoint;
import com.auth.tokensystem.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of(appProperties.getUrls().getFrontend()));
